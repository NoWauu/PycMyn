...
joueur = player.Player(
    pygame.Vector3(32, 32, 2), (texture_player, {'normal': [texture_player, texture_player_2]}, {'normal': [200, 200]}), 1.5)

fantome1 = fantome.Fantome(pygame.Vector3(128, 96, 2), (texture_fantome, {'fear': [texture_fantome_fear, texture_fantome,
                                                                                   texture_fantome_fear, texture_fantome,
                                                                                   texture_fantome_fear, texture_fantome,
                                                                                   texture_fantome_fear]},
                                                        {'fear': [3000, 400, 300, 200, 200, 200, 200]}))
